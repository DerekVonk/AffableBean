 ...
 */
@Stateless
@TransactionManagement(TransactionManagementType.CONTAINER) //default setting, implemented for readability
public class OrderManager {

    @PersistenceContext(unitName = "AffableBeanPU")
    private EntityManager em;

    @TransactionAttribute(TransactionAttributeType.REQUIRED) //default setting, implemented for readability
